                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="purchase" className="cursor-pointer">
                          {t('form.subjects.purchase')}
                        </SelectItem>
                        <SelectItem value="custom" className="cursor-pointer">
                          {t('form.subjects.custom')}
                        </SelectItem>
                        <SelectItem value="visit" className="cursor-pointer">
                          {t('form.subjects.visit')}
                        </SelectItem>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-muted/30 rounded-lg p-6 border border-border/40">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">{t('info.hours')}</h3>
