      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground mt-2">Join our community of musicians and collectors</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                disabled={isLoading}
              />
              <p className="text-xs text-muted-foreground mt-1.5">Must be at least 8 characters long</p>
            </div>
