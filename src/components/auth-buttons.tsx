...
export function AuthButtons({ mode, callbackUrl = '/' }: AuthButtonsProps) {
  const actionText = mode === 'signin' ? 'Sign in' : 'Sign up'

  const handleOAuthSignIn = (provider: 'google') => {
    // | 'facebook' | 'apple' // Not implemented for now
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Facebook - Not implemented for now */}
      {/* <Button
        type="button"
        variant="outline"
        size="lg"
